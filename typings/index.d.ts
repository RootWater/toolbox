 ...
 * @param target 目标对象
 */
export declare const checkType: (target: any) => {
    /**
     * 验证类型是否一致
     * @param t 校验类型
     *
 ...
 * @param sub 搜索字符
 */
export declare const countMatches: (str: string, sub: string) => number;
export { debounce }
export { deburr }
 ...
 * @default defaultVal ''
 */
export declare const defaultIfEmpty: <T>(target: T, defaultVal?: any) => T;
export { defaults }
export { defaultsDeep }
export { delay }
 ...
 * @param str 目标字符串
 */
export declare const deleteWhitespace: (str: string) => string;
export { difference }
export { differenceBy }
 ...
 * @param target 目标对象
 */
export declare const getRawType: (target: any) => string;
export { has }
export { hasIn }
export { initial }
export { inRange }
 ...
 * @param target 目标对象
 */
export declare const isEmpty: (target: any) => any;
export { isEqual }
export { isEqualWith }
export { kebabCase }
export { lowerCase }
 ...
 */
export declare const obj2FormData: (obj: Object, ...ignoreKeys: string[]) => FormData;
export { omit }
export { omitBy }
export { once }
 ...
 * @param str2 字符串 2
 */
export declare const strEqualIgnoreCase: (str1: string, str2: string) => boolean;
